window.wailsbindings = '{"api":{"HelloApi":{"Hello":{"name":"api.HelloApi.Hello","inputs":[{"type":"*types.Request"}],"outputs":[{"type":"*types.Response"}]}}},"main":{"App":{"Greet":{"name":"main.App.Greet","inputs":[{"type":"string"}],"outputs":[{"type":"string"}]}}}}';
(()=>{
